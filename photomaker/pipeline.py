...
class PhotoMakerStableDiffusionXLPipeline(StableDiffusionXLPipeline):
    ...
    def load_photomaker_adapter(
        ...
        **kwargs,
        ...
        print(f"加载 PhotoMaker 组件 [1] id_encoder from [{pretrained_model_name_or_path_or_dict}]...")
        ...
        print(f"加载 PhotoMaker 组件 [2] lora_weights from [{pretrained_model_name_or_path_or_dict}]")
